class FixedCost < ApplicationRecord
  ...
  def create_monthly_costs
    ...
    while current_date <= recurring_end_date
      FixedCost.create(
        ...
        fixed_cost_money: fixed_cost_money,
        recurring_start_date: current_date,
        recurring_end_date: current_date,
        user_id: user_id,
        location_id: location_id
      )
      current_date += recurring_day.months
    end
  end
  ...
  def create_weekly_costs
    ...
    while current_date <= recurring_end_date
      ...
      current_date += recurring_day.weeks
    end
  end
  ...
  def create_daily_costs
    ...
    while current_date <= recurring_end_date
      ...
      current_date += recurring_day.days
    end
  end
end
